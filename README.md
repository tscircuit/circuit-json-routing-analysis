...
primary ordering key. Equal scores are ordered by the number of components
intersecting the region, trace count, net count, and finally the region
coordinates. The CLI can therefore print the analyzer output directly without
implementing its own ranking rules.
...
```xml
<CongestedRegion severity="high" probabilityOfFailure="2.7%" traceCount="1" netCount="1" componentsIntersectingRegion="0" left="-4.6mm" right="-4.5mm" bottom="-18.7mm" top="-18.2mm" width="0.1mm" height="0.5mm">
...
<CongestedRegion severity="high" probabilityOfFailure="2.1%" traceCount="2" netCount="2" componentsIntersectingRegion="0" left="-18.9mm" right="-18.4mm" bottom="6.9mm" top="7.3mm" width="0.6mm" height="0.4mm">
